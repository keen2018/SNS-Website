...
# 账号配置
git config --list
git config --global user.name "keen2018"
git config --global user.email "keen123@163.com"
# 本地仓库
git init
git status -s
git add *
git commit -m '...'
# 生成秘钥
ssh-keygen -t rsa -C "keenteam123@163.com"
# 推送已有项目
git remote add origin https://github.com/keen2018/SNS-Website.git
